...
const policyPatterns: Array<{ policyId: string; patterns: RegExp[] }> = [
  ...
  { policyId: 'curb-local-exactions', patterns: [/摊派/, /抑配/, /强征/, /胥吏/, /监司.*(?:查|抽验)/, /查禁/, /整顿吏治/, /吏治[：:]/, /地方执行/, /州县.*(?:执行|奉行)/, /抽查.*(?:地区|州县).*执行/, /诏令.*(?:落到|落实).*州县/, /(?:额外|重复)(?:加收|收费|催收)/, /多收.*钱/, /强迫.*青苗/] },
  ...
  { policyId: 'cross-check-ledgers', patterns: [/对勘/, /账簿/, /账册/, /账目/, /查账/, /交叉核验/, /追查.*钱/, /账面.*(?:入库|库存)/] },

    ...
    polity: {
      offices: [
        ...
        },
        {
          ...
          scope: '军政、边防、将兵调度',
          posts: [
            { key: 'military-commissioner', title: '枢密使', appointeeId: 'wen-yanbo' },
        ...
        },
        {
          ...
          scope: '盐铁、度支、户部财赋',
          posts: [
            { key: 'finance-commissioner', title: '三司使', appointeeId: null },
        ...
        },
        {
          ...
          posts: [
            ...
            { key: 'remonstrance-chief', title: '知谏院', appointeeId: null },
          ],
          reform: '旧制未改',
        },
        {
          ...
          scope: '地方财赋、输纳、州县执行',
          posts: [
            { key: 'transport-commissioner', title: '转运使', appointeeId: null },
